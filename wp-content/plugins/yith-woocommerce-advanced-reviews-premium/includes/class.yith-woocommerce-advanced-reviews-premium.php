...
//        }
    ...
    function yith_ywar_show_reviews( $atts, $content ){
        ...
        if (isset ($atts['product_id'])){
            ...
            $args['numberposts'] = isset($atts['reviews_number']) ? $atts['reviews_number'] : -1;


            $this->reviews_list( $atts['product_id'], $args, $show_featured = false );
        }
        else{

            $args = array(
                'numberposts'   => isset($atts['reviews_number']) ? $atts['reviews_number'] : -1,
            );

            $this->reviews_list( null, $args, $show_featured = false );
        }
